-- Update all database functions to use support_messages instead of messages

-- 1. Update get_order_messages function
...
-- 2. Update send_message function
...
-- 3. Update mark_order_messages_read function
...
-- 4. Update get_chat_notifications function
  ...
  WITH unread_counts AS (
    SELECT
      ...
      (SELECT p.full_name FROM profiles p 
       JOIN support_messages msg ON p.id = msg.sender_id
