        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white sm:text-5xl md:text-6xl mt-[30px]">
              ...
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-sunset to-purple-500">Simples et Efficaces</span>
            </h1>
            ...
            <div className="mt-8 flex gap-4">
              <Link to="/register" className="px-6 py-3 rounded-md text-white bg-gradient-to-r from-sunset to-purple-500 hover:opacity-90 font-medium">Commander maintenant</Link>
              <Link to="/services" className="px-6 py-3 rounded-md border border-sunset text-sunset hover:bg-sunset/10 font-medium">Nos Services</Link>
            </div>
          </motion.div>
